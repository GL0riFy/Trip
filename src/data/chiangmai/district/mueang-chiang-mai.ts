...
export const MueangChiangMaiOTOP = [
  {
    ...
    title: {
      ...
      zh: "优质泰国丝绸和漆器",
      th: "ผ้าไหมไทยพรีเมียมและเครื่องเขิน"
    },
    price: {
      en: "300 - 2000 THB",
      zh: "300 - 2000 泰铢",
    ...
    detail: {
      ...
      th: "ผ้าไหมไทยคุณภาพดีจากแหล่งผลิตในอำเภอเมืองเชียงใหม่ และเครื่องเขินดั้งเดิม มีทั้งผ้าพันคอ เสื้อผ้า ของประดับตกแต่ง และเฟอร์นิเจอร์สุดประณีต"
    },
    detail_more: {
  ...
  },
  {
    ...
    title: {
      ...
      zh: "本地手工艺品和艺术",
      th: "งานหัตถกรรมและงานศิลปะท้องถิ่น"
    },
    price: {
      en: "50 - 1000 THB",
      zh: "50 - 1000 泰铢",
    ...
    detail: {
      ...
      th: "ของทำมือสวยงามจากช่างฝีมือในเชียงใหม่ ทั้งงานแกะสลักไม้ เครื่องปั้นดินเผา หน้ากากเพ้นท์สี และของตกแต่งศิลปะ ของขวัญทางวัฒนธรรมที่เหมาะสำหรับเป็นของฝาก"
    },
    detail_more: {
  ...
  },
  {
    ...
    title: {
      ...
      zh: "传统甜点和本地食品",
      th: "ขนมหวานแบบดั้งเดิมและอาหารพื้นเมือง"
    },
    price: {
      en: "40 - 300 THB",
      zh: "40 - 300 泰铢",
    ...
    detail: {
      ...
      th: "ขนมไทยและของว่างแบบดั้งเดิมของเชียงใหม่ที่ทำตามสูตรลับที่สืบทอดกันมายาวนาน รวมทั้งขนมข้าวเหนียว ลูกอมมะพร้าว และผลไม้แช่อิ่ม"
    },
    detail_more: {

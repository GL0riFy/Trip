export interface DistrictHistory {
  ...
  export const districtHistory: Record<string, DistrictHistory> = {
    "mae-ai": {
      ...
      th: {
        summary:
          "แม่อายเป็นอำเภอเหนือสุดที่ติดพม่า ขึ้นชื่อเรื่องยอดเขาในสายหมอก มรดกชาวไทใหญ่ และวัฒนธรรมพรมแดนอันมีชีวิตชีวา",
        paragraphs: [
          "แม่อายตั้งอยู่ปลายเหนือสุดของจังหวัดเชียงใหม่ มีพรมแดนติดรัฐฉานของพม่า ภูมิประเทศโดดเด่นด้วยทิวเขาแดนลาวและจุดสูงสุดคือดอยผาหมีนม่อก ซึ่งเป็นยอดเขาลำดับสองของไทย สูง 2,285 เมตร",
          "ในอดีตพื้นที่นี้เป็นเส้นทางค้าขายระหว่างอาณาจักรล้านนากับดินแดนชาวไทใหญ่ ขบวนการค้าชา ไหม และของป่าผ่านแม่อายมาหลายศตวรรษ สะท้อนความหลากหลายของชาวไทใหญ่ ลาหู่ อาข่า และคนล้านนา",
          "ปัจจุบันแม่อายขึ้นชื่อเรื่องอากาศเย็น สวนส้มไต่ระดับ และแม่น้ำกกที่ไหลคดเคี้ยว วัดธาตุชมพูบนหน้าผาสูงเหนือแม่น้ำกกยังเป็นสถานที่ศักดิ์สิทธิ์ที่นักท่องเที่ยวแวะไหว้",
        ],
      },
    },
    ...
    "fang": {
      ...
      th: {
        summary:
          "ฝางเป็นอำเภอเก่าแก่ของเชียงใหม่ เคยเป็นเมืองหน้าด่านล้านนา และเป็นที่ตั้งของบ่อน้ำมันเชิงพาณิชย์แห่งแรกของไทย",
        paragraphs: [
          "กษัตริย์มังรายทรงสถาปนาฝางในปลายศตวรรษที่ 13 เป็นป้อมปราการเหนือของล้านนา ตำแหน่งริมแม่น้ำกกทำให้เป็นศูนย์กลางการปกครองและป้องกันชายแดนมายาวนาน",
          "ในทศวรรษ 1920 มีการค้นพบน้ำมันดิบ ทำให้ฝางมีแหล่งผลิตน้ำมันบนบกแห่งเดียวและเก่าแก่ที่สุดของประเทศ ข้อเท็จจริงที่หลายคนยังไม่เคยรู้",
          "ฝางยังมีน้ำพุร้อนบำบัดในอุทยานแห่งชาติดอยผาหมีนม่อก และหุบเขาอุดมสมบูรณ์ปลูกลิ้นจี่และสตรอว์เบอร์รีชั้นเลิศของภาคเหนือ",
        ],
      },
    },
    ...
    "chiang-dao": {
      ...
      th: {
        summary:
          "เชียงดาวโดดเด่นด้วยดอยหินปูนสูงชัน—ดอยเชียงดาว—ยอดเขาลำดับสามของไทยและแหล่งศักดิ์สิทธิ์ที่ชาวบ้านเคารพมานานกว่าพันปี",
        paragraphs: [
          "ชื่อ “เชียงดาว” หมายถึง “เมืองดาว” สะท้อนความสูงและท้องฟ้ายามค่ำคืนที่แจ่มชัด ภูมิประเทศโดยรอบคือมวลดอยเชียงดาว อนุรักษ์ชีวมณฑลของยูเนสโก สูงถึง 2,195 เมตร",
          "ริมเชิงเขามีถ้ำเชียงดาว ถ้ำใหญ่ที่มีความศักดิ์สิทธิ์ มีพระพุทธรูปและศาลเจ้าให้แสวงบุญจากทั่วภาค",
          "อากาศเย็นสนับสนุนเกษตรอินทรีย์ เช่น กาแฟ เสาวรส และผักอเมซอน ที่เป็นที่รู้จักทั่วประเทศ",
        ],
      },
    },
    ...
    "mueang": {
      ...
      th: {
        summary:
          "อำเภอเมืองเชียงใหม่เป็นหัวใจทางประวัติศาสตร์และวัฒนธรรมของจังหวัด ผสานมรดกล้านนาในเมืองเก่ากับชีวิตเมืองสมัยใหม่",
        paragraphs: [
          "พระยามังรายทรงสถาปนาเมื่อ พ.ศ. 1839 เป็นราชธานีล้านนา ใจกลางเมืองยังมีซากกำแพงและคูเมืองล้อมรอบ",
          "ภายในและรอบคูเมืองมีวัดพุทธเก่าแก่นับร้อย ทั้งวัดพระสิงห์และวัดเจดีย์หลวง สะท้อนสถาปัตยกรรมล้านนาอันวิจิตร",
          "วันนี้เมืองเชียงใหม่เป็นศูนย์กลางศิลปะ อาหาร และชุมชนนักทำงานระยะไกล ผสานขนบดั้งเดิมกับไลฟ์สไตล์ร่วมสมัย",
        ],
      },
    },
    ...
    "doi-saket": {
      ...
      th: {
        summary:
          "ดอยสะเก็ดเป็นอำเภอเกษตรกรรมเงียบสงบ ขึ้นชื่อเรื่องชนบทสวย หมู่บ้านหัตถกรรม และวัดพระธาตุดอยสะเก็ดบนยอดเขา",
        paragraphs: [
          "อยู่ทางตะวันออกเฉียงเหนือของตัวเมือง ดอยสะเก็ดเสนอชีวิตล้านนาแบบชนบท ทิวนาข้าวและคลองสายน้ำไหลเวียน",
          "จุดยึดของอำเภอคือวัดพระธาตุดอยสะเก็ด วิหารใหญ่บนยอดเขา มีจิตรกรรมฝาผนังและวิวหุบเขา",
          "นักท่องเที่ยวแวะชมธรรมชาติ น้ำพุร้อน และชุมชนหัตถกรรมใกล้เคียงอย่างบ่อสร้าง สะท้อนวัฒนธรรมงานฝีมือลึกซึ้ง",
        ],
      },
    },
    ...
    "mae-rim": {
      ...
      th: {
        summary:
          "แม่ริมเป็นประตูสู่ธรรมชาติ ขึ้นชื่อหุบเขาเขียวขจี น้ำตกชั้นๆ และรีสอร์ทหรูท่ามกลางสายหมอก",
        paragraphs: [
          "ห่างจากตัวเมืองเพียงขับรถสั้นๆ แม่ริมเป็นช่วงเชื่อมระหว่างที่ราบกับดอยสูง ป่าเขียวหนาแน่น สัตว์ป่าหลากชนิด",
          "พื้นที่นี้มีสวนพฤกษศาสตร์สมเด็จพระนางเจ้าสิริกิติ์และจุดชมวิวม่อนแจ่ม เป็นที่นิยมของคนท้องถิ่นและนักท่องเที่ยว",
          "แม่ริมพัฒนาเป็นแหล่งอีโคทัวร์และผจญภัย ทั้งอุทยานช้าง ไร่สตรอว์เบอร์รี ซิปไลน์ และคาเฟ่บนดอย",
        ],
      },
    },
    ...
    "hang-dong": {
      ...
      th: {
        summary:
          "หางดงผสานชุมชนสมัยใหม่กับมรดกงานฝีมือ โดยเฉพาะหมู่บ้านแกะสลักไม้บ้านท่าวาย",
        paragraphs: [
          "หางดงอยู่ทางใต้ของตัวเมืองเชียงใหม่ พัฒนาจากชานเกษตรเงียบสู่พื้นที่อยู่อาศัยและพาณิชย์คึกคัก",
          "อำเภอนี้เป็นที่ตั้งของบ้านท่าวาย หมู่บ้านแกะสลักไม้และงานจำลองโบราณที่มีชื่อเสียงระดับโลก",
          "นอกจากงานฝีมือ หางดงยังมีแกรนด์แคนยอนหางดงและอุทยานแห่งชาติอบขาน ดึงดูดทั้งคนรักธรรมชาติและนักผจญภัย",
        ],
      },
    },
    ...
    th: {
      summary:
        "ไชยปราการเป็นอำเภอหลากวัฒนธรรม ดินด่านอุดมสมบูรณ์ และหินปูนทิวทัศน์งาม",
      paragraphs: [
        "แยกตั้งจากอำเภอฝางใน พ.ศ. 2531 ตั้งอยู่ในหุบเขาอุดมล้อมรอบด้วยทิวเขาแดนลาว",
        "พื้นที่ปลูกกระเทียม หอม และข้าวคุณภาพ ได้รับน้ำเลี้ยงจากแม่น้ำแฟง",
        "แหล่งท่องเที่ยวเด่นคืออุทยานหินผางาม มักถูกเปรียบว่า “คุนหมิงเมืองไทย” มีภูมิประเทศหินปูนชวนตื่นตาและถ้ำซับซ้อน",
      ],
    },
  },
  ...
  "chom-thong": {
    ...
    th: {
      summary:
        "จอมทองเป็นที่ตั้งของดอยอินทนนท์ ยอดเขาสูงสุดของไทย อุดมไปด้วยมรดกทางจิตวิญญาณและธรรมชาติอันงดงาม",
      paragraphs: [
        "อยู่ทางใต้ของตัวเมืองเชียงใหม่ ภูมิประเทศโดดเด่นด้วยอุทยานแห่งชาติดอยอินทนนท์ จึงได้รับสมญานาม “หลังคาของประเทศไทย”",
        "ใจกลางอำเภอมีวัดพระธาตุศรีจอมทององค์สำคัญ ประดิษฐานพระบรมสารีริกธาตุ ดึงดูดผู้แสวงบุญตลอดปี",
        "ภูมิประเทศภูเขามีน้ำตกวชิรธารและแม่ยะ รวมถึงสถานีโครงการหลวงปลูกพืชเมืองหนาว",
      ],
    },
  },
  ...
  "mae-on": {
    ...
    th: {
      summary:
        "แม่ออนเป็นอำเภอภูเขาเงียบสงบ ขึ้นชื่อน้ำพุร้อนบำบัดและหมู่บ้านอีโคทัวร์แม่กำปอง",
      paragraphs: [
        "เดิมเป็นส่วนหนึ่งของสันกำแพง ก่อนแยกเป็นอำเภอเพื่อบริหารพื้นที่ชนบทและท่องเที่ยวเชิงอนุรักษ์",
        "แม่กำปองเป็นหมู่บ้านริมหุบเขาเขียวชอุ่ม ชาวบ้านรักษาวิถีดั้งเดิมควบคู่การท่องเที่ยวอย่างยั่งยืน",
        "นักท่องเที่ยวแวะน้ำพุร้อนสันกำแพง (พื้นที่ในแม่ออน) ต้มไข่ในน้ำแร่และพักผ่อนท่ามกลางขุนเขา",
      ],
    },
  },
  ...
  "san-kamphaeng": {
    ...
    th: {
      summary:
        "สันกำแพงเป็นศูนย์กลางหัตถกรรมดั้งเดิมของเชียงใหม่ โด่งดังร่มบ่อสร้างและผ้าไหมคุณภาพ",
      paragraphs: [
        "หลายชั่วอายุคน สันกำแพงคือหัวใจช่างฝีมือภาคเหนือ โดยเฉพาะแนว “ถนนหัตถกรรม”",
        "หมู่บ้านร่มบ่อสร้างคือมุกเม็ดงาม ช่างทำและลงสีร่มกระดาษสีสันสดด้วยเทคนิคโบราณ",
        "นอกจากร่ม ยังมีการทอไหม เซลาดอน และเครื่องเงิน เป็นแหล่งเรียนรู้งานพื้นถิ่น",
      ],
    },
  },
  ...
  "mae-taeng": {
    ...
    th: {
      summary:
        "แม่แตงคือสนามผจญภายของเชียงใหม่ ป่าทึบ อุทยานช้างเชิงจริยธรรม และเขื่อนแม่งัดสมบูรณ์ชล",
      paragraphs: [
        "ทางเหนือของตัวเมืองเป็นพื้นที่ภูเขาสูงสลับซับซ้อน หุบเขาแม่น้ำลึกและอุทยานเขียวขจี",
        "นิยมล่องแก่งแม่น้ำแม่แตง และเยี่ยมศูนย์ช้างกู้ไทยในป่า อย่างมีความรับผิดชอบ",
        "เขื่อนแม่งัดสมบูรณ์ชลให้น้ำชลประทานและทิวน้ำกว้าง นักท่องเที่ยวพักแพลอยน้ำท่ามกลางขุนเขา",
      ],
    },
  },
  };
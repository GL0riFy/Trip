...
export default function WelcomePopup() {
  ...
  useEffect(() => {
    // เช็คว่าเคยเห็น Popup หรือยังใน Session นี้
  ...
  const handleClose = () => {
    setIsOpen(false);
    // บันทึกลง SessionStorage ว่า "ดูแล้วนะ" 
    // ค่านี้จะหายไปเมื่อปิด Tab หรือปิด Browser
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 animate-backdrop">
        ...
        <div className="bg-white rounded-[32px] p-8 max-w-4xl w-full shadow-2xl relative max-h-[95vh] overflow-y-auto animate-popup">
          ...
          <div className="text-center pt-2">
            ...
            <p className="text-lg sm:text-xl font-medium text-gray-600 mb-8">ดื่มด่ำกับซอฟต์พาวเวอร์อันล้ำค่า</p>
